 ...
 */
function charmed_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function charmed_sanitize_css( $css ) {
 ...
 */
function charmed_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function charmed_sanitize_email( $email, $setting ) {
 ...
 */
function charmed_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function charmed_sanitize_html( $html ) {
 ...
 */
function charmed_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function charmed_sanitize_nohtml( $nohtml ) {
 ...
 */
function charmed_sanitize_number_absint( $number, $setting ) {
...
function charmed_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 *                    the setting default.
 */
function charmed_sanitize_number_range( $number, $setting ) {
 ...
 */
function charmed_sanitize_select( $input, $setting ) {
 ...
 */
function charmed_sanitize_url( $url ) {
